...
$(function() {
	...
	$(".chattingroom").click(function() {
		...
		window.open("http://localhost:900/chatting/"+encodeURIComponent(roomname)+"?name="+encodeURIComponent(nickname)+"?email="+encodeURIComponent(email), '1', 'width=600, height=800, resizable=no');
	});
});
</script>
...
%>
        ...
        <li class="dropdown">
         ...
         <%    
               ...
               { 
         %>
                     <li><a href="Logout.listen"><span class="glyphicon glyphicon-send" aria-hidden="true"> 로그아웃</a></li>
            <%    
                  } 
            %>
          </ul>
