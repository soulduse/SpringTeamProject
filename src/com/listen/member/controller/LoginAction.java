...
public class LoginAction extends BaseController {
	...
	// facebookLogin
	public String m_facebookLogin(HttpServletRequest request,
			HttpSession session) {
	...
	public String m_LoginAction(HttpServletRequest request, HttpSession session) {
		...
		if (EmailList.size() != 0 && pass.equals(password)) {
			...
			return "redirect:/m_main.listen"; // main.jsp 넘어가는부분 web과 다른페이지로
												// 넘겨야할듯... mMain.jsp라던지
		} else {
	...
	@RequestMapping("/mMemberInfo.listen")
	// 회원정보보기
	...
	//
	public String facebookJoin(HttpServletRequest request, HttpSession session,
			facebookVo fbv) {
	...
	//
	public String m_facebookJoin(HttpServletRequest request,
			HttpSession session, facebookVo fbv) {
